...
T = TypeVar("T", bound="MediaDescriptor")


@_attrs_define
class MediaDescriptor:
    """The standalone media API's shared shape — single lookup, project listing, and the upload-ticket/confirm responses.
    `url`/`urlExpiresAt` are null until `uploaded`.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        media_descriptor.additional_properties = d
