...
### Added
- Initial release of the SwipeFlow Python SDK, generated from the public SwipeFlow OpenAPI spec (https://api.swipeflow.io/v1/openapi.json) with openapi-python-client: sync and async endpoint functions and typed models under `swipeflow_api.generated`.
